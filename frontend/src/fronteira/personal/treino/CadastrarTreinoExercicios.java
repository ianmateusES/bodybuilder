 ...
 * @author Vivi
 */
public class CadastrarTreinoExercicios extends javax.swing.JFrame {

    /**
     * Creates new form FormularioRefeicaoAlimentos
     */
    public CadastrarTreinoExercicios() {
        initComponents();
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        String exercicio = jComboBox2.getSelectedItem().toString();
        String tempo_descanco = jTextField6.getText();
        String series = jTextField1.getText();
        String repeticoes = jTextField2.getText();
